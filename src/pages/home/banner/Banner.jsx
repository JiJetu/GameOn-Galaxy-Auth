        ...
        <div className=" relative h-[60vh]">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
                <div className="text-center bg-black bg-opacity-25 h-full p-5 md:py-24 md:px-32 space-y-4">
                    <h2  data-aos="fade-down" className="text-2xl md:text-5xl text-yellow-400 font-semibold">Game On, Legends!</h2>
                    <p data-aos="fade-down" className="text-yellow-100">Get ready for an exhilarating gaming experience like no other. Whether you're a seasoned esports pro or a casual gamer, this tournament is your chance to shine, compete, and earn bragging rights in the gaming world.</p>
